<?php $__env->startSection('title', 'VIST — Компʼютери для бізнесу та життя'); ?>
...
<div class="background-video-container">
    <video autoplay loop muted id="myVideo">
        <source src="<?php echo e(asset('img/video/vist__cinematic.mp4')); ?>" type="video/mp4">
...
<section class="vist-productivity-section">
    <div class="vist-productivity-wrapper">
        ...
        <div class="vist-image-column">
            <img src="<?php echo e(asset('img/waiting.jpg')); ?>" alt="Співробітник, що чекає через повільний комп'ютер">
        </div>
    </div>
</section>
...
<section class="vist-productivity-section vist-productivity-section--reversed">
    <div class="vist-productivity-wrapper vist-productivity-wrapper--reversed">
        ...
        <div class="vist-image-column vist-image-column--reversed">
            <img src="<?php echo e(asset('img/success.jpg')); ?>" alt="Успішна команда з продуктивними робочими станціями">
        </div>
...
<div class="brands-slider swiper">
    <div class="swiper-wrapper">
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/intel-logo.webp')); ?>" alt="intel"></div>
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/amd-logo.webp')); ?>" alt="AMD"></div>
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/asus-logo.webp')); ?>" alt="asus"></div>
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/nvidia-logo.webp')); ?>" alt="nvidia"></div>
		<div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/dell-logo.webp')); ?>" alt="dell-logo"></div>
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/radeon-logo.webp')); ?>" alt="radeon"></div>
		<div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/apc-logo.webp')); ?>" alt="apc-logo"></div>
		<div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/gigabyte-logo.webp')); ?>" alt="gigabyte-logo"></div>
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/aruba-logo.webp')); ?>" alt="aruba-logo"></div>
		<div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/hp-logo.webp')); ?>" alt="hp-logo"></div>
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/eaton-logo.webp')); ?>" alt="eaton-logo"></div>
 		<div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/grandstream-logo.webp')); ?>" alt="grandstream-logo"></div>
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/kingston-logo.webp')); ?>" alt="kingston-logo"></div>
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/logitech-logo.webp')); ?>" alt="logitech-logo"></div>
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/msi-logo.webp')); ?>" alt="msi-logo"></div>
		<div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/supermicro-logo.webp')); ?>" alt="supermicro-logo"></div>
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/synology-logo.webp')); ?>" alt="synology-logo"></div>
        <div class="swiper-slide"><img src="<?php echo e(asset('img/logo/hard/transcend-logo.webp')); ?>" alt="transcend-logo"></div>
    </div>
</div>
...
<div class="cards-grid">
    <div class="card">
        <img src="<?php echo e(asset('img/icon/cad.jpg')); ?>" alt="CAD/CAM/CAE" class="icon">
    ...
    <div class="card">
        <img src="<?php echo e(asset('img/icon/arch.jpg')); ?>" alt="CAD/CAM/CAE" class="icon">
    ...
    <div class="card">
        <img src="<?php echo e(asset('img/icon/media.jpg')); ?>" alt="CAD/CAM/CAE" class="icon">
    ...
    <div class="card">
        <img src="<?php echo e(asset('img/icon/data.jpg')); ?>" alt="CAD/CAM/CAE" class="icon">
    ...
    <div class="card">
        <img src="<?php echo e(asset('img/icon/hpc.jpg')); ?>" alt="CAD/CAM/CAE" class="icon">
    ...
    <div class="card">
        <img src="<?php echo e(asset('img/icon/it6.jpg')); ?>" alt="CAD/CAM/CAE" class="icon">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\liqwood\Herd\vist-laravel\resources\views/home/index.blade.php ENDPATH**/ ?>